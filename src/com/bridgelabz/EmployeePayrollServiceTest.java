...
public class EmployeePayrollServiceTest {
	...
	/**
	 * Purpose : To test whether the number of records present in the database
	...
	/**
	 * Purpose : To test whether the salary is updated in the database and is synced
	 * with the DB - Read the values from the database - Update the salary in the
	 * database - Test whether the database is correctly synced or not
	 */
	@Test
